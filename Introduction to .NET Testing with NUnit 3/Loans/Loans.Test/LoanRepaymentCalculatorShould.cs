...
namespace Loans.Test
{
    ...
    public class LoanRepaymentCalculatorShould
    {
                                                     ...
                                                     decimal expectedMonthlyPayment)
        {
            ...
            Assert.That(monthlyPayment,Is.EqualTo(expectedMonthlyPayment).Within(10).Percent);
        }
        ...
        [Test]
        [TestCaseSource(typeof(MonthlyRepaymentTestData),"TestCase")]
        ...
        [Test]
        [TestCaseSource(typeof(MonthlyRepaymentsTestDataWithReturn),"TestCase")]
        public decimal CalculateCorrectMonthlyRepayment_CentralizedTestCase(decimal principal,
            decimal interestRate,
            int termInYears)
        {
            var sut = new LoanRepaymentCalculator();
        ...
        public void CalculateCorrectMonthlyRepayment_Range(
            ...
            [Range(0.5,20.000,0.5)]decimal interestRate,
            [Values(10,20,30)] int termInYears)
        {
            var sut = new LoanRepaymentCalculator();
